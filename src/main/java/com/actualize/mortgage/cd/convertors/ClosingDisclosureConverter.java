...
package com.actualize.mortgage.cd.convertors;
...
import com.actualize.mortgage.cd.datamodels.Address;
import com.actualize.mortgage.cd.datamodels.AmortizationRule;
import com.actualize.mortgage.cd.datamodels.BuydownOccurence;
import com.actualize.mortgage.cd.datamodels.BuydownRule;
import com.actualize.mortgage.cd.datamodels.CashToCloseItem;
import com.actualize.mortgage.cd.datamodels.CashToCloseItems;
import com.actualize.mortgage.cd.datamodels.ClosingAdjustmentItem;
import com.actualize.mortgage.cd.datamodels.ClosingCostFund;
import com.actualize.mortgage.cd.datamodels.ClosingInformation;
import com.actualize.mortgage.cd.datamodels.ClosingInformationDetail;
import com.actualize.mortgage.cd.datamodels.Construction;
import com.actualize.mortgage.cd.datamodels.Deal;
import com.actualize.mortgage.cd.datamodels.Document;
import com.actualize.mortgage.cd.datamodels.DocumentClass;
import com.actualize.mortgage.cd.datamodels.DocumentClassification;
import com.actualize.mortgage.cd.datamodels.EscrowDetail;
import com.actualize.mortgage.cd.datamodels.EscrowItem;
import com.actualize.mortgage.cd.datamodels.EscrowItemDetail;
import com.actualize.mortgage.cd.datamodels.EscrowItemPayment;
import com.actualize.mortgage.cd.datamodels.EscrowItems;
import com.actualize.mortgage.cd.datamodels.EstimatedPropertyCostComponents;
import com.actualize.mortgage.cd.datamodels.Fee;
import com.actualize.mortgage.cd.datamodels.FeePayment;
import com.actualize.mortgage.cd.datamodels.FeeSummaryDetail;
import com.actualize.mortgage.cd.datamodels.Fees;
import com.actualize.mortgage.cd.datamodels.Foreclosures;
import com.actualize.mortgage.cd.datamodels.HighCostMortgages;
import com.actualize.mortgage.cd.datamodels.IntegratedDisclosureDetail;
import com.actualize.mortgage.cd.datamodels.IntegratedDisclosureSectionSummaries;
import com.actualize.mortgage.cd.datamodels.IntegratedDisclosureSectionSummary;
import com.actualize.mortgage.cd.datamodels.IntegratedDisclosureSectionSummaryDetail;
import com.actualize.mortgage.cd.datamodels.IntegratedDisclosureSubsectionPayment;
import com.actualize.mortgage.cd.datamodels.IntegratedDisclosureSubsectionPayments;
import com.actualize.mortgage.cd.datamodels.InterestOnly;
import com.actualize.mortgage.cd.datamodels.InterestRateAdjustment;
import com.actualize.mortgage.cd.datamodels.InterestRatePerChangeAdjustmentRule;
import com.actualize.mortgage.cd.datamodels.LateChargeRule;
import com.actualize.mortgage.cd.datamodels.Liabilities;
import com.actualize.mortgage.cd.datamodels.Liability;
import com.actualize.mortgage.cd.datamodels.LicenseDetail;
import com.actualize.mortgage.cd.datamodels.LoanDetail;
...
import com.actualize.mortgage.cd.datamodels.NegativeAmortization;
import com.actualize.mortgage.cd.datamodels.Other;
import com.actualize.mortgage.cd.datamodels.PartialPayment;
import com.actualize.mortgage.cd.datamodels.Parties;
import com.actualize.mortgage.cd.datamodels.Party;
import com.actualize.mortgage.cd.datamodels.Payment;
import com.actualize.mortgage.cd.datamodels.PrepaidItem;
import com.actualize.mortgage.cd.datamodels.PrepaidItemPayment;
import com.actualize.mortgage.cd.datamodels.PrepaidItems;
import com.actualize.mortgage.cd.datamodels.PrepaymentPenaltyLifetimeRule;
import com.actualize.mortgage.cd.datamodels.PrincipalAndInterestPaymentAdjustment;
import com.actualize.mortgage.cd.datamodels.PrincipalAndInterestPaymentPerChangeAdjustmentRule;
import com.actualize.mortgage.cd.datamodels.ProjectedPayment;
import com.actualize.mortgage.cd.datamodels.ProjectedPayments;
import com.actualize.mortgage.cd.datamodels.PropertyDetail;
import com.actualize.mortgage.cd.datamodels.PropertyValuationDetail;
...
import com.actualize.mortgage.cd.domainmodels.ClosingCostDetailsLoanCosts;
import com.actualize.mortgage.cd.domainmodels.ClosingCostDetailsOtherCosts;
...
import com.actualize.mortgage.cd.domainmodels.ClosingCostsTotal;
...
import com.actualize.mortgage.cd.domainmodels.ClosingInformationModel;
...
import com.actualize.mortgage.cd.domainmodels.ContactInformationModel;
import com.actualize.mortgage.cd.domainmodels.CostsAtClosing;
import com.actualize.mortgage.cd.domainmodels.CostsAtClosingCashToClose;
import com.actualize.mortgage.cd.domainmodels.CostsAtClosingClosingCosts;
...
import com.actualize.mortgage.cd.domainmodels.LicenseDetailModel;
import com.actualize.mortgage.cd.domainmodels.LoanCalculationModel;
import com.actualize.mortgage.cd.domainmodels.LoanCalculationsQualifiedMortgage;
...
import com.actualize.mortgage.cd.domainmodels.LoanTerms;
...
import com.actualize.mortgage.cd.domainmodels.PayoffsAndPayments;
...
import com.actualize.mortgage.cd.domainmodels.ProjectedPaymentsEE;
import com.actualize.mortgage.cd.domainmodels.ProjectedPaymentsET;
import com.actualize.mortgage.cd.domainmodels.ProjectedPaymentsMI;
import com.actualize.mortgage.cd.domainmodels.ProjectedPaymentsPC;
import com.actualize.mortgage.cd.domainmodels.ProjectedPaymentsPI;
...
import com.actualize.mortgage.cd.domainmodels.SummariesofTransactions;
import com.actualize.mortgage.cd.domainmodels.SummariesofTransactionsDetailsBorrowerTransaction;
import com.actualize.mortgage.cd.domainmodels.SummariesofTransactionsDetailsDueFromSellerAtClosing;
import com.actualize.mortgage.cd.domainmodels.SummariesofTransactionsDetailsPaidByAlready;
import com.actualize.mortgage.cd.domainmodels.SummariesofTransactionsDetailsSellerTransaction;
import com.actualize.mortgage.cd.domainmodels.TermsOfLoanModel;
import com.actualize.mortgage.cd.domainmodels.TransactionInformation;
import com.actualize.mortgage.cd.utils.Convertor;
import com.actualize.mortgage.cd.utils.StringFormatter;
...
public class ClosingDisclosureConverter {
    ...
    public ClosingDisclosure convertXmltoJSON(MISMODocument mismodoc) {
        ...
        Deal deal = new Deal(Deal.NS, (Element)document.getElementAddNS("DEAL_SETS/DEAL_SET/DEALS/DEAL"));
	        ...
	        closingDisclosure.setClosingCostDetailsLoanCosts(createClosingCostDetailsLoanCosts(document));
    ...
    private ClosingCostsTotal createClosingCostsTotal(Deal deal)
    {
    	...
    	closingCostsTotal.setTotalClosingCosts(integratedDisclosureSectionSummary.integratedDisclosureSectionSummaryDetail.integratedDisclosureSectionTotalAmount);
...
/*
    ...
    */
	...
	private EscrowItemModel getEscrowModel(EscrowItem escrowItem)
	{
		...
		iePatClosing.setBpAtClosing(escrowItemDetail.escrowItemEstimatedTotalAmount);
